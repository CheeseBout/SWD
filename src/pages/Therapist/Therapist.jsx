                      ...
                      <div className="flex">
                        {[0, 1, 2, 3, 4, 5].map((rating) => (
                          <button
                            key={`min-${rating}`}
                            onClick={() =>
                              handleRatingChange("minRating", rating)
                            }
                            className={`p-1.5 ${
                      ...
                      <div className="flex">
                        {[1, 2, 3, 4, 5].map((rating) => (
                          <button
                            key={`max-${rating}`}
                            onClick={() =>
                              handleRatingChange("maxRating", rating)
                            }
                            className={`p-1.5 ${
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              ...
              {(filters.minRating > 0 || filters.maxRating < 5) && (
                <span className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-yellow-50 text-yellow-700">
                  Rating: {filters.minRating === 0 ? "Any" : filters.minRating}★
                  to {filters.maxRating}★
                  <XCircleIcon
                    className="h-4 w-4 ml-1 cursor-pointer"
                    onClick={() => {
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 bg-gray-50 rounded-lg border border-gray-100 shadow-sm">
            ...
            <p className="text-gray-500 mt-2 max-w-md mx-auto">
              ...
              adjusting your search criteria or browse all therapists.
            </p>
            <button
              onClick={clearFilters}
